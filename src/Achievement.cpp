...
Achievement::Achievement(int _id, std::string _description, char _type, std::string _category, float _progress)
        : id{_id}, description{std::move(_description)}, type{_type}, category{std::move(_category)},
          progress{_progress} {}
